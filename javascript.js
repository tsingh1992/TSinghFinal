//Global variables 
var canvas, canvas_context1, UserColor, sketch, sketch_style, mouse, saveButton;
...
window.onload = function() {
			...
			//rectangle sample 
			//canvas_context2.fillRect(100, 100, 50, 30);
			 x = 100;
			 y = 100;
		}
...
function FreeStyleDrawing(obj)  {
	...
	//get the width of the render div element and assign it to the value of canvas width.Returns the value of the specified style property  
		//canvas.width = parseInt(sketch_style.getPropertyValue('width'));
	//get the height of the render div element and assign it to the value of canvas height. Returns the value of the specified style property 
...
function saveButtonPress (){
	...
	{
		alert("Other browsers, please right click on the image and save as a new name");
		//other browsers
